...
from chat_wb.neo4j.utils import (convert_neo4j_node_to_model, convert_neo4j_relationship_to_model,
                                 convert_neo4j_message_to_model, convert_neo4j_scene_to_model)
...
# [TODO] test
    ...
    def create_message_node(self, tx: Transaction, data: WebSocketInputData, ai_response: str,
                            user_input_entity: Triplets | None, create_time: str) -> MessageNode:
